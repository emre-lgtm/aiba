    ...
    <section id="about" className="section-padding bg-stone-50">
      <div className="container-luxury">
        ...
        >
          ...
          >
            Crafting <span className="text-gradient">Timeless</span> Beauty
          </h2>
          <p className="text-stone-500 text-lg leading-relaxed">
            For over 15 years, AIBA STONE has been the premier destination for
            luxury natural stone. We source the world&apos;s finest marble,
            travertine, and limestone to transform your vision into reality.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            <h3
              ...
              style={{ fontFamily: "var(--font-playfair)" }}
            >
              From Quarry to Your Space
            </h3>
            <p className="text-stone-500 leading-relaxed mb-6">
              We partner directly with quarries in Italy, Turkey, India, and
              Brazil to bring you the rarest and most exquisite natural stones.
              Every slab is hand-selected by our expert team to ensure
              uncompromising quality.
            </p>
            <p className="text-stone-500 leading-relaxed mb-8">
              Our master craftsmen combine traditional techniques with
              cutting-edge CNC technology to deliver precision results that
              exceed expectations. From concept to installation, we handle every
              detail.
            </p>
          ...
          {stats.map((stat) => (
            ...
            >
              <div className="w-14 h-14 mx-auto mb-4 bg-gradient-to-br from-bronze-100 to-bronze-200 rounded-xl flex items-center justify-center group-hover:from-bronze-500 group-hover:to-bronze-700 transition-all duration-500">
                <stat.icon className="w-7 h-7 text-bronze-700 group-hover:text-white transition-colors duration-500" />
              </div>
              <span
